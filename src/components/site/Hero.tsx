...
export function Hero() {
  return (
    <section
      id="home"
      className="relative isolate w-full overflow-hidden min-h-[max(560px,calc(100vh-65px))] sm:min-h-[max(560px,calc(100vh-105px))] flex items-center pt-16 pb-6 lg:pt-20 lg:pb-8"
    >
      {/* Background video */}
