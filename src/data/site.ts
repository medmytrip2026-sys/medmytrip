...
export const doctors: Doctor[] = [
  ...
  // Top IVF / Fertility Specialists
  {
    ...
    hospital: "Bloom IVF Group",
    city: "Delhi",
    designation: "Co-founder & Medical Director",
    image: "/doctors/dr-nandita-p-palshetkar.webp",
    about:
      "Dr. Nandita P. Palshetkar is Co-founder and Medical Director of Bloom IVF Group, a chain of fertility centres operating across eight cities in India including Fortis Bloom IVF Centres in New Delhi and Gurgaon. She has practised reproductive medicine for over 35 years and has helped more than 25,000 couples conceive.\n\nShe was among the first specialists in India to introduce techniques such as the Embryoscope, ICSI, IMSI and laser-assisted hatching, having trained at fertility centres in Copenhagen and Melbourne. She served as President of FOGSI (Federation of Obstetric and Gynaecological Societies of India) in 2019.",
    experience: "35+ years",
    qualifications: [
      "MD",
      "FCPS",
      "FRCOG (UK) — Honorary Fellowship, Royal College of Obstetricians and Gynaecologists",
      "FICOG",
    ],
    procedures: [
    ...
    awards: [
      "Past President, FOGSI (2019)",
      "Lifetime Achievement Award, Indian Society for Assisted Reproduction (ISAR)",
    ],
  },
  {
    ...
    image: "/doctors/dr-rita-bakshi.jpg",
    about:
      "Dr. Rita Bakshi is Founder and Chairperson of RISAA IVF, one of Delhi's oldest and most established fertility clinics, with centres across Delhi, Haryana and Rajasthan. She has more than 35 years of experience as a gynaecologist and fertility specialist and has completed over 4,000 ART cycles.\n\nHer practice covers IVF, IUI, ICSI, surrogacy, recurrent miscarriage, endometriosis and ovulatory disorders. She is also the founder of the UPKAAR Surrogacy Welfare Trust.",
    experience: "35+ years",
    qualifications: [
      "MBBS — Lady Hardinge Medical College, New Delhi (1983)",
      "MD (Obstetrics & Gynaecology) — Safdarjung Hospital, New Delhi (1990)",
      "Diploma in Obstetrics & Gynaecology — St. Stephen's Hospital (1987)",
      "Diploma in ART — KKIVF Hospital, Singapore",
    ...
    awards: [
      "Distinguished Doctor Award, Delhi Medical Association (2023)",
      "Icon of the Year (IVF Specialist, North) — The Economic Times (2022)",
  ...
  },
  {
    ...
    specialization: "IVF & Infertility",
    hospital: "Max Multispeciality Hospitals",
    city: "Delhi NCR",
    designation: "Senior Director & Head, IVF and Reproductive Medicine",
    image: "/doctors/dr-surveen-ghumman-sindhu.png",
    about:
      "Dr. Surveen Ghumman Sindhu is Senior Director and Head of the Department of IVF and Reproductive Medicine at Max Multispeciality Hospitals, with units in Saket, Panchsheel Park and Patparganj in Delhi, and in Gurgaon. She has over 30 years of experience in reproductive medicine and infertility treatment, with specialised expertise in low ovarian reserve, recurrent IVF failure, male infertility and fertility preservation.\n\nShe trained in Assisted Reproductive Technologies at the Cleveland Clinic, USA, and is a certified clinical embryologist from Manipal University. She has authored several books on reproductive endocrinology and has served the Indian Fertility Society as Editor and Treasurer.",
    experience: "30+ years",
    qualifications: [
      "Specialized training in Assisted Reproductive Technologies and IVF — Cleveland Clinic, USA",
      "Certified Clinical Embryologist — Manipal University",
      "Fellowship in Minimal Access Surgery — World Association of Laparoscopic Surgeons",
    ],
    procedures: [
      "IVF",
      "ICSI",
  ...
  },
  {
    ...
    specialization: "IVF & Infertility",
    hospital: "Femmenest Centre for IVF & Gynaecology",
    city: "Delhi NCR",
    designation: "Director, IVF & Infertility",
    image: "/doctors/dr-sowjanya-aggarwal.jpg",
    about:
      "Dr. Sowjanya Aggarwal heads the Femmenest Centre for IVF and Gynaecology in Anand Vihar, Delhi, and is Director of IVF & Infertility and Laparoscopic & Robotic Gynae Surgery at Max Hospital, Vaishali. She has over 20 years of clinical experience in obstetrics, gynaecology and reproductive medicine.\n\nFollowing her postgraduate training in Obstetrics & Gynaecology, she completed a fellowship in Minimal Access Gynae Surgery and Reproductive Medicine in Cochin, Kerala. She is a member of the Indian Society for Assisted Reproduction (ISAR), the Indian Association of Gynaecological Endoscopists (IAGE) and the Gurgaon Obstetrics & Gynaecologic Society (GOGS).",
    experience: "20+ years",
    qualifications: [
      "MBBS — JSS Medical College, Mysore",
      "MS (Obstetrics & Gynaecology) — Sri Ramachandra Medical College, Chennai (2008)",
      "Fellowship in Minimal Access Gynae Surgery & Reproductive Medicine (IVF) — Cochin, Kerala",
    ],
    procedures: [
      "IVF",
      "IUI",
  ...
  },
  {
    ...
    specialization: "IVF & Infertility",
    hospital: "Seeds of Innocence",
    city: "Delhi NCR",
    designation: "Founder-Director",
    image: "/doctors/dr-gauri-agarwal.jpg",
    about:
      "Dr. Gauri Agarwal is Founder-Director of Seeds of Innocence, a chain of IVF centres that has grown from a single Malviya Nagar clinic in 2015 to more than 14 centres across North India, and of Genestrings Diagnostics, a genetic testing laboratory. She has over 20 years of experience in gynaecology and infertility and has overseen the delivery of more than 21,000 babies.\n\nShe has been an early adopter of technologies such as PRP and preimplantation genetic screening (PGS/PGD) in her practice, and completed a fellowship in reproductive medicine at the University of Gent, Belgium, with embryology training at the National University of Singapore.",
    experience: "20+ years",
    qualifications: [
      "MBBS — Bharati Vidyapeeth Medical College, Pune",
      "DNB (Obstetrics & Gynaecology) — KG Superspeciality Hospital, Coimbatore",
      "Fellowship in Reproductive Medicine (Infertility) — University of Gent, Belgium",
      "Training in Embryology — National University of Singapore",
    ],
    procedures: [
      "IVF",
      "PGS/PGD genetic screening",
      "PRP therapy",
      "Failed IVF cycle management",
      "Low AMH / low ovarian reserve treatment",
  ...
  },
  {
    ...
    specialization: "IVF & Infertility",
    hospital: "Apollo Fertility",
    city: "Delhi NCR",
    designation: "Clinical Lead & Senior Consultant, Fertility & IVF",
    image: "/doctors/dr-bhavna-banga.webp",
    about:
      "Dr. Bhavna Banga is Clinical Lead and Senior Consultant in the Department of Fertility & IVF at Apollo Fertility, Lajpat Nagar (New Delhi) and Sector 18, Noida, and also consults at Apollo Clinic, East of Kailash. She has over 19 years of experience managing both routine and complex infertility cases.\n\nShe holds MBBS and MS degrees and has received advanced clinical training in fertility centres across the UK, USA, Canada, Australia, Spain and Brazil, with a particular interest in male infertility and reproductive surgery.",
    experience: "19+ years",
    qualifications: [
      "MBBS — Pune University",
      "MS (Obstetrics & Gynaecology) — Mumbai University",
  ...
  },
  {
    ...
    city: "Delhi",
    designation: "Emeritus Consultant, Centre of IVF & Human Reproduction",
    image: "/doctors/dr-abha-majumdar.png",
    about:
      "Dr. Abha Majumdar is Emeritus Consultant at the Centre of IVF and Human Reproduction, Sir Ganga Ram Hospital, New Delhi, where she has been attached since 1987. She led the team that delivered the first IVF baby at the hospital, and in northern India, on 21 September 1991, and went on to head and later direct the Centre from 2001 to 2023.\n\nHer practice focuses on the full range of infertility management with a special focus on assisted reproductive techniques, reproductive endocrinology, and laparoscopic and hysteroscopic corrective surgery. She is current President of the Indian Fertility Society and holds life memberships of FOGSI, AOGD and ISAR.",
    experience: "45+ years",
    qualifications: [
      "MBBS — S.N. Medical College, Agra University (1974)",
      "MS — S.N. Medical College, Agra University (1978)",
      "FICS — International College of Surgeons (1994)",
    ],
    procedures: [
      "IVF and associated ART techniques",
      "Reproductive endocrinology",
      "Laparoscopic and hysteroscopic corrective surgery",
      "High-risk IVF pregnancy management",
    ],
    awards: [
      "Medical Excellence Award (Lifetime Achievement) in Obstetrics & Gynaecology — Hippocrates Foundation (2014)",
      "Lifetime Achievement Award — FERTIVISION '17 (2021)",
    ],
  },
  {
    ...
    specialization: "IVF & Infertility",
    hospital: "ART Fertility Clinics",
    city: "Delhi",
    designation: "Co-Medical Director, India",
    image: "/doctors/dr-parul-katiyar.webp",
    about:
      "Dr. Parul Katiyar is Co-Medical Director, India, at ART Fertility Clinics' New Delhi centre and a member of the clinic's founding team of clinicians in the country. She has over 23 years of experience and has been part of more than 3,000 assisted conception cycles.\n\nShe holds an MD/MS in Obstetrics and Gynaecology from JN Medical College, Aligarh, and a master's in human reproduction from the University of Valencia, Spain, with further clinical training at Yale School of Medicine and Androfert, Brazil. Her clinical interests include reproductive endocrine disorders, endometriosis and male infertility.",
    experience: "23+ years",
    qualifications: [
      "MBBS — G.S.V.M. Medical College, Kanpur (2002)",
      "MD/MS (Obstetrics & Gynaecology) — J.N. Medical College, AMU Aligarh (2006)",
      "Master's in Biotechnology of Human Reproduction — University of Valencia, Spain",
      "Advanced clinical training — Yale School of Medicine, USA, and Androfert, Brazil",
    ],
    procedures: [
      "IVF",
      "ICSI",
    ...
    awards: ["IFS Achiever Award — Fertivision 2024"],
  },
  {
    ...
    hospital: "Apollo Fertility",
    city: "Noida",
    designation: "Senior IVF Consultant",
    image: "/doctors/dr-malti-madhu.webp",
    about:
      "Dr. Malti Madhu is a Senior IVF Consultant at Apollo Fertility, Noida, and also practises at Genesis Fertility Solutions in Greater Noida. She has 15 years of experience in infertility treatment and has performed more than 1,000 IVF cycles, with particular expertise in failed IVF cycles, ICSI and donor egg IVF.\n\nShe holds MBBS and DNB qualifications along with a postgraduate certificate in Reproduction and Development from the University of Bristol, UK, and trained in fertility-enhancing surgery in Tübingen, Germany. She is an associate member of the RCOG and a member of the Indian Fertility Society and ESHRE.",
    experience: "15+ years",
    qualifications: [
      "MBBS",
      "DNB (Obstetrics & Gynaecology)",
      "Master's Certificate in Reproduction & Development — University of Bristol, UK",
      "Training in Fertility Enhancing Surgery — Tübingen, Germany",
    ],
    procedures: [
      "IVF",
      "ICSI",
      "Failed IVF cycle management",
      "Egg donation / donor IVF",
      "IUI",
      "Blastocyst culture",
    ],
    awards: ["Mithila Samman award"],
  },
  {
    id: "dr-ila-gupta-ivf",
    name: "Dr. Ila Gupta",
    specialization: "IVF & Infertility",
    hospital: "Ferticity IVF & Fertility Clinics",
    city: "Delhi",
    designation: "Director & Senior Consultant",
    image: "/doctors/dr-ila-gupta.jpg",
    about:
      "Dr. Ila Gupta is Director and Senior Consultant at Ferticity IVF & Fertility Clinics, Malviya Nagar, Delhi, with over 29 years of experience in infertility treatment and assisted reproductive technologies. She has performed more than 8,000 procedures with reported IVF success rates of up to 78%.\n\nShe trained in reproductive medicine and ART in Kiel, Germany, and in endoscopy in Clermont, France, and was a member of the expert committee that helped shape India's ART (Regulation) Act, 2020. She has also served as Executive and Website Editor of the Indian Fertility Society.",
    experience: "29+ years",
    qualifications: [
      "MBBS — Gajra Raja Medical College, Gwalior",
      "MS (Obstetrics & Gynaecology) — Rani Durgawati Medical College, Jabalpur",
      "Senior Residency — St. Stephen's Hospital, Delhi",
  ...
  // Top Dental Specialists
  {
    ...
    hospital: "Matrix Dental and Skin Lounge, Vasant Vihar",
    city: "Delhi",
    designation: "Prosthodontist & Implantologist",
    image: "/doctors/dr-sourabh-nagpal.jpg",
    about:
      "Dr. Sourabh Nagpal is a Prosthodontist and Implantologist who runs Matrix Dental and Skin Lounge in Vasant Vihar, South Delhi, with over 13 years of clinical experience. He holds a Fellowship and Diplomate in Implantology from the ICOI, USA (2010) and a postgraduate certificate in Cosmetic & Esthetic Dentistry from UCLA (2012). His practice centers on dental implants, crowns, bridges and dentures, alongside cosmetic work such as smile design and soft-tissue contouring.",
    experience: "13+ years",
    qualifications: [
      "BDS",
      "MDS — Prosthodontics & Implantology",
      "Fellowship & Diplomate in Implantology — ICOI, USA (2010)",
      "PGDE (Cosmetic & Esthetic Dentistry) — University of California, Los Angeles (2012)",
    ],
    procedures: [
      "Dental implantology",
      ...
      "Root canal treatment (rotary endodontics)",
    ],
    awards: [
      "Member, Indian Dental Association",
      "Member, Indian Association of Oral and Maxillofacial Pathologists",
    ],
  },
  {
    id: "dr-bhutani-dental",
    name: "Dr. Deepak Bhutani",
    specialization: "Dental Care",
    hospital: "Dr. Bhutani Dental Clinic, Rajouri Garden",
    city: "Delhi",
    designation: "Consultant Oral & Maxillofacial Prosthodontist and Implantologist",
    image: "/doctors/dr-bhutani.jpg",
    about:
      "Dr. Deepak Bhutani is Consultant Oral and Maxillofacial Prosthodontist and Implantologist at Dr. Bhutani Dental Clinic, Rajouri Garden, New Delhi, with more than 21 years of experience. He completed his BDS at KLE's Dental College, Belgaum, and his MDS in Prosthodontics, Crown & Bridge and Implantology at A.B. Shetty Dental College, Mangalore. He has held consulting positions at Fortis Vasant Kunj, Fortis Jesaram Karol Bagh and Apollo Clinic, and has authored papers in the Journal of Prosthetic Dentistry and the Journal of Indian Prosthodontic Society.",
    experience: "21+ years",
    qualifications: [
      "BDS — KLE's Dental College, Belgaum (Rajiv Gandhi University of Health Sciences), 1996–2001",
      "MDS (Prosthodontics, Crown & Bridge, Implantology) — A.B. Shetty Dental College, Mangalore (RGUHS), 2002–2005",
    ],
    procedures: [
    ...
    workExperience: [
      ...
      "Consultant, Fortis, Vasant Kunj",
      "Senior Consultant, Apollo Clinic",
      "Senior Consultant, Khetarpal Hospital",
      "HOD, Maharishi Charak Charitable Hospital, Mansarover Garden",
    ],
  },
  {
    ...
    name: "Dr. Richa Vats",
    specialization: "Dental Care",
    hospital: "Aashlok Hospital, Safdarjung Enclave",
    city: "Delhi NCR",
    designation: "Dentist & Prosthodontist",
    image: "/doctors/dr-richa-vats.jpg",
    about:
      "Dr. Richa Vats is a Dentist and Prosthodontist practising at Aashlok Hospital, Safdarjung Enclave, with over 9 years of clinical experience. She holds a BDS from Subharti Dental College, Meerut, and an MDS in Prosthodontics and Crown & Bridge from Himachal Dental College. She is also a visiting consultant at Jaypee Hospital, Noida, and several clinics across Delhi NCR, with particular focus on rotary endodontics and restorative dental care.",
    experience: "9+ years",
    qualifications: [
      "BDS — Subharti Dental College, Meerut",
      "MDS — Prosthodontics and Crown & Bridge, Himachal Dental College, Sundernagar, Himachal Pradesh",
    ],
    procedures: [
      "Prosthodontics (crowns & bridges)",
      "Rotary endodontics / root canal treatment",
      "General restorative dentistry",
      "Management of toothache and gum disease",
    ],
  },
  ...
  // Top Eye / Ophthalmology Specialists
  {
    ...
    image: "/doctors/dr-mahipal-s-sachdev.webp",
    about:
      "Dr. Mahipal S. Sachdev is Chairman and Medical Director of Centre for Sight, a leading chain of eye hospitals he founded in 1996 after serving as Assistant Professor at AIIMS, New Delhi. He completed his MBBS and MD in Ophthalmology at AIIMS and pursued advanced fellowship training in cornea and refractive surgery at Georgetown University in the United States. He is regarded as a pioneer of phacoemulsification in India and co-authored the country's first book on the subject, A Practical Guide to Phacoemulsification; he later introduced SMILE and blade-free femto cataract technology to India. Dr. Sachdev has served as President of the All India Ophthalmological Society and the Delhi Ophthalmological Society, and has published over 115 indexed journal articles. He was awarded the Padma Shri in 2007 for his contributions to Indian medicine.",
    experience: "42+ years",
    qualifications: [
      "MBBS, All India Institute of Medical Sciences (AIIMS), New Delhi (1981)",
      "MD Ophthalmology, AIIMS (1984)",
      "DNB",
      "MNAMS",
      "FRCS",
      "FICO (UK)",
      "FAICO",
      "Fellowship in Cornea and Refractive Surgery, Georgetown University, Washington D.C.",
    ],
    procedures: [
      "Phacoemulsification cataract surgery",
      "SMILE (Small Incision Lenticule Extraction)",
      "LASIK and iLASIK refractive surgery",
      "Blade-free femto cataract surgery",
      "Cornea transplant",
      "Keratoconus treatment",
      "Phakic IOL implantation",
      "Dry eye and ocular surface treatment",
    ],
    awards: [
      "Padma Shri (2007)",
      "President, All India Ophthalmological Society (2019–present)",
      "Former President, Delhi Ophthalmological Society",
    ],
  },
  {
    id: "dr-s-n-jha-eye",
    ...
    hospital: "Sir Ganga Ram Hospital",
    city: "Delhi",
    designation: "Senior Consultant & Chairperson, Department of Ophthalmology",
    image: "/doctors/dr-s-n-jha.png",
    about:
      "Dr. S.N. Jha is a Senior Consultant and Chairperson of the Department of Ophthalmology at Sir Ganga Ram Hospital, New Delhi, with over four decades of clinical experience. He completed his MBBS at Patna Medical College in 1982 and his MD in Ophthalmology at the All India Institute of Medical Sciences, New Delhi, in 1986, later undertaking an advanced fellowship at the Dr. R.P. Centre for Ophthalmic Sciences, AIIMS. His clinical practice is centered on vitreoretinal disease, uveitis, and complex cataract and corneal surgery, including vitrectomy, glaucoma valve implantation, and corneal grafting. He has served as an examiner for the DNB and FNB courses under the National Board of Examinations and as an executive member of the Delhi Ophthalmological Society. Dr. Jha has been honored with the J.N. Rohatgi Oration and the Pioneer Award for his contributions to ophthalmology.",
    experience: "40+ years",
    qualifications: [
      "MBBS, Patna Medical College, Patna (1982)",
      "MD Ophthalmology, All India Institute of Medical Sciences (AIIMS), New Delhi (1986)",
      "Advanced Fellowship, Dr. R.P. Centre for Ophthalmic Sciences, AIIMS (2019–2021)",
    ],
    procedures: [
      ...
      "Uvea disorders",
      "Corneal grafting / cornea transplant",
      "Cataract surgery",
    ],
    awards: ["J.N. Rohatgi Oration (2020)", "Pioneer Award (2019)"],
  },
  {
    ...
    hospital: "Medanta",
    city: "Delhi NCR",
    designation: "Chairman, Department of Ophthalmology",
    image: "/doctors/dr-sudipto-pakrasi.png",
    about:
      "Dr. Sudipto Pakrasi is Chairman of the Department of Ophthalmology at Medanta, South Delhi, with over 40 years of clinical experience. He completed his MBBS at Maulana Azad Medical College in 1982 and his MD in Ophthalmology at the Dr. Rajendra Prasad Centre for Ophthalmic Sciences, AIIMS, in 1984, followed by a DNBE from the National Board of Examinations in 1987. He is credited with pioneering advanced phacoemulsification techniques in India starting in 1993 and introducing torsional phacoemulsification in 2004, and he led the team that brought exclusive EDOF intraocular lenses to Asia in 2013. His clinical focus spans cataract and refractive surgery, corneal disease, and glaucoma management, and he has led a surgical team that has performed over 3,000 femto-laser cataract surgeries. Dr. Pakrasi is a gold medalist from AIIMS and has spoken at numerous national and international ophthalmology conferences.",
    experience: "40+ years",
    qualifications: [
      "MBBS, Maulana Azad Medical College (MAMC), New Delhi (1982)",
      "MD Ophthalmology, Dr. Rajendra Prasad Centre for Ophthalmic Sciences (RP Centre), AIIMS (1984)",
      "DNBE, National Board of Examinations (1987)",
    ],
    procedures: [
      "Phacoemulsification cataract surgery",
      ...
      "LASIK / Femto-LASIK",
      "ICL implantation",
      "EDOF intraocular lens implantation",
    ],
    awards: ["Gold Medalist, AIIMS (2017)"],
  },
