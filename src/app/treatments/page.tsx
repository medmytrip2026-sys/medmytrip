...
export const metadata: Metadata = {
  ...
  description:
    "Browse Medical, Aesthetic and Wellness treatments across India's top hospitals — transparent pricing and trusted specialists.",
  openGraph: {
    title: "Find Treatments — MedMyTrip",
    description:
      "Browse Medical, Aesthetic and Wellness treatments across India's top hospitals — transparent pricing and trusted specialists.",
        ...
        <section className="relative isolate overflow-hidden bg-gradient-to-br from-primary via-primary to-accent py-20 text-white">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 max-w-2xl text-lg text-white/85">
              Explore Medical, Aesthetic and Wellness treatments across India's top hospitals —
              transparent pricing, verified specialists.
            </p>
          </div>
        </section>
        <Suspense>
